...
global.sig = 'https://instagram.com/sofati.stfu' //Link Instagrammu
...
/*============== PAYMENT ==============*/
global.pdana = '083894063406' //Nomor Danamu
global.ppulsa = '083894063406' //Nomor SimCard Yang Kamu Pake
global.pgopay = '083894063406'
global.povo = '083894063406'
global.psaweria = 'https://saweria.co/SofatiGT' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6285719913161' //Nomor Bot
global.nomorown = '6283894063406' //Nomor Owner
global.namebot = 'SoftBOTZ-MD' //Nama Bot
global.nameown = 'SofatiXD࿐' // Nama Owner
global.wame = 'https://api.whatsapp.com/send?phone=+6283894063406'
global.tautanwa = 'https://wa.me/message/CKSVELUVK252N1' //kalau bisa link wa bisnis kalian


/*============== STAFF ==============*/
global.owner = [
  ['6283894063406', 'SofatiXD࿐ ', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 SoftBOTZ-MD汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘SoftBOTZ-MD˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ SoftBOTZ-MD'
global.namedoc = 'SoftBOTZ-MD' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋 ┊ SoftBOTZ-MD ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ SoftBOTZ-MD'
